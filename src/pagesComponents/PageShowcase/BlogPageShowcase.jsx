...
const pageComponents = {
  BlogPage: `https://github.com/Omi-Patel/retroUI_Component/tree/main/src/pagesComponents`,
  RetroBlogPage: `https://github.com/Omi-Patel/retroUI_Component/tree/main/src/pagesComponents`,
  SimpleBlogPage: `https://github.com/Omi-Patel/retroUI_Component/tree/main/src/pagesComponents`,
};
...
const BlogPageShowcase = () => {
  ...
  const [activeTabs, setActiveTabs] = useState({
    BlogPage: "preview",
    RetroBlogPage: "preview",
    SimpleBlogPage: "preview"
  });
          ...
          <div className="relative z-10 py-12 px-8 sm:px-12 flex flex-col md:flex-row items-center justify-between gap-8 rounded-2xl border border-amber-200/50 dark:border-amber-800/30">
            <div className="text-center md:text-left max-w-2xl">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                Explore our collection of retro-themed blog page templates,
                designed to showcase your content with a unique vintage
